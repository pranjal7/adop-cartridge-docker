...
def printDockerfile = freeStyleJob(projectFolderName + "/Print_Docekerfile")
...
getDockerfile.with{
  ...
  publishers{
    ...
    downstreamParameterized{
      trigger(projectFolderName + "/Print_Docekerfile"){
...
printDockerfile.with{
	description("This job prints the Docker file")
	parameters{
